...
const ServiceCard = ({ index, title, icon }) => (
  <Tilt className="xs:w-[250px] w-50 border border-cyan-500 rounded-md shadow-md shadow-cyan-200  bg-slate-950 ">
  ...
  return (
    <>
      ...
      <motion.p variants={fadeIn("", "", 0.1, 1)} className="mt-4 text-secondary text-[17px] max-w-3xl leading-[30px]">
        I'm a skilled software developer with experience in TypeScript and JavaScript, and expertise in frameworks like React, Node.js, and Three.js. I'm a quick learner and collaborate closely with clients to create
